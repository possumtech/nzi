...
--- Run a system command and optionally capture output to context
...
--- @param signal_type string: The type to project as (default "run")
function M.run(command, bufnr, line, silent, signal_type)
  local s_type = signal_type or "run";
